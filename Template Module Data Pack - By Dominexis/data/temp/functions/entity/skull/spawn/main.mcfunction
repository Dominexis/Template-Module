...
summon area_effect_cloud ~ ~1024 ~ {Tags:["nexus.entity","temp.entity","temp.entity.type.skull","temp.entity.part.damage_sensor"                       ,"nexus.entity.target.spawn","nexus.entity.air_toggle"                    ],Age:-2147483648,Duration:-1,WaitTime:-2147483648,Passengers:[{id:"minecraft:pig"        ,Tags:["nexus.entity","temp.entity","temp.entity.type.skull","temp.entity.part.damage_sensor","nexus.entity.target.spawn","nexus.entity.damage_sensor.event"],DeathLootTable:"",NoAI:1b,Silent:1b,PersistenceRequired:1b,Attributes:[{Base:1024.0d,Name:"minecraft:generic.max_health"}],Health:1024.0f,ActiveEffects:[{Id:14,ShowParticles:0b,Duration:2147483647}]}]}
