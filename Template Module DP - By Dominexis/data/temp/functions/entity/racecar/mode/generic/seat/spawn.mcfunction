...
execute positioned ~ ~1024 ~ run teleport @e[type=area_effect_cloud,distance=..8,tag=temp.entity.part.seat,tag=nexus.entity.target,limit=1] ~ ~-1024 ~
execute positioned ~ ~1024 ~ run teleport @e[type=skeleton_horse   ,distance=..8,tag=temp.entity.part.seat,tag=nexus.entity.target,limit=1] ~ ~-1024 ~
